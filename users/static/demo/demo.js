...
demo = {
    ...
    initDashboardPageCharts: function() {
        ...
        var chart_data = [11, 0, 0, 0, 0, 0, 0, 0, 0, 80, 110, 100];
        ...
        $("#1").click(function() {
            var chart_data = [0, 120, 105, 110, 95, 105, 90, 100, 80, 95, 70, 120];
            var data = myChartData.config.data;
            data.datasets[0].data = chart_data;
            data.labels = chart_labels;
            myChartData.update();
        ...
        $("#2").click(function() {
            var chart_data = [0, 80, 65, 130, 80, 105, 90, 130, 70, 115, 60, 130];
            var data = myChartData.config.data;
            data.datasets[0].data = chart_data;
            data.labels = chart_labels;
            myChartData.update();
